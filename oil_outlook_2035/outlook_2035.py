...
data = pd.read_csv('bp_outlook_2035_oil_production.csv')
data.columns = ['date',
                'north_america',
...
ax.set_ylabel('Projected Crude Oil Production (million tonnes of oil equivalent )')
plt.savefig('oil_outlook_2035.png')
plt.savefig('oil_outlook_2035.pdf')
plt.show()
